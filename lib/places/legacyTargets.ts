...
export const LEGACY_TARGETS: LegacyTarget[] = [
  ...
  { name: 'Biblioteca Municipal Ricardo Palma', localidad: 'Miraflores, Lima', country: 'pe', category: 'library' },
  { name: 'Biblioteca Santa Cruz', localidad: 'Miraflores, Lima', country: 'pe', category: 'library' },
