-- 0035 minted redemption codes with a 1-hour window; the Partner-facing
-- copy (app/partner/actions.ts, PartnerDashboard.tsx) was updated to say
-- 10 minutes instead — a shorter window means a shared/photographed code
-- is far less useful to someone who isn't actually at the register. This
-- brings checkin_at_space in line with that copy. Only the interval
-- changes; everything else is identical to 0035's version.
